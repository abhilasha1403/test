...
from proj.util import get_gpu_memory
from proj.util.parameter_utils import EnvArgumentParser, _genenv_ignoring_key_case
...
def huggingface_loader(llm_adapter: LLMModelAdapter, model_params: ModelParameters):
    ...
    from proj.model.llm.compression import compress_module
    ...
    if device == "cpu":
        ...
        if version < (4, 35, 0):
            from proj.model.llm.monkey_patch import (
...
def llamacpp_loader(
    ...
    try:
        from proj.model.llm.llama_cpp.llama_cpp import LlamaCppModel
    except ImportError as exc:
        raise ValueError(
