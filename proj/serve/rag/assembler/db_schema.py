...
from proj.rag.chunk_manager import ChunkManager, ChunkParameters
...
from proj.serve.rag.assembler.base import BaseAssembler
...
class DBSchemaAssembler(BaseAssembler):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from proj.rag.embedding.embedding_factory import DefaultEmbeddingFactory
    ...
    def load_knowledge(self, knowledge: Optional[Knowledge] = None) -> None:
        ...
        for table_summary in table_summaries:
            from proj.rag.knowledge.base import KnowledgeType
