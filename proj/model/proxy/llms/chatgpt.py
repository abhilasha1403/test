...
from proj.model.utils.chatgpt_utils import OpenAIParameters
...
class OpenAILLMClient(ProxyLLMClient):
    def __init__(
        ...
        **kwargs,
        ...
        if self._openai_less_then_v1:
            from proj.model.utils.chatgpt_utils import _initialize_openai
    ...
    def client(self) -> ClientType:
        ...
        if self._client is None:
            from proj.model.utils.chatgpt_utils import _build_openai_client
