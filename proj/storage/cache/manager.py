...
from proj.core import CacheConfig, CacheKey, CacheValue, Serializable, Serializer
from proj.core.interface.cache import K, V
from proj.storage.cache.storage.base import CacheStorage
...
def initialize_cache(
    ...
    if storage_type == "disk":
        try:
            from proj.storage.cache.storage.disk.disk_storage import DiskCacheStorage
