...
class RemoteEmbeddingFactory(EmbeddingFactory):
    ...
    def create(
        ...
        from proj.model.cluster.embedding.remote_embedding import RemoteEmbeddings
...
class LocalEmbeddingFactory(EmbeddingFactory):
    ...
    def _load_model(self) -> "Embeddings":
        from proj.model.cluster.embedding.loader import EmbeddingLoader
        from proj.model.cluster.worker.embedding_worker import _parse_embedding_params
