...
from proj.model.adapter.base import LLMModelAdapter, register_model_adapter
from proj.model.adapter.template import ConversationAdapter, ConversationAdapterFactory
from proj.model.base import ModelType
from proj.model.parameter import ProxyModelParameters
from proj.model.proxy.base import ProxyLLMClient
from proj.model.proxy.llms.proxy_model import ProxyModel
...
class ProxyLLMModelAdapter(LLMModelAdapter):
    ...
    def dynamic_llm_client_class(
        ...
        if params.llm_client_class:
            from proj.util.module_utils import import_from_checked_string
...
class OpenAIProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.chatgpt import chatgpt_generate_stream
...
class TongyiProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.tongyi import tongyi_generate_stream
...
class ZhipuProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.zhipu import zhipu_generate_stream
...
class WenxinProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.wenxin import wenxin_generate_stream
...
class GeminiProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.gemini import gemini_generate_stream
...
class SparkProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.spark import spark_generate_stream
...
class BardProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.bard import bard_generate_stream
...
class BaichuanProxyLLMModelAdapter(ProxyLLMModelAdapter):
    ...
    def get_async_generate_stream_function(self, model, model_path: str):
        from proj.model.proxy.llms.baichuan import baichuan_generate_stream
