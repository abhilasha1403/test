...
from proj.rag.knowledge.string import StringKnowledge
from proj.rag.knowledge.url import URLKnowledge
...
class KnowledgeFactory:
    ...
    def _get_knowledge_subclasses() -> List[Knowledge]:
        ...
        from proj.rag.knowledge.csv import CSVKnowledge
        from proj.rag.knowledge.docx import DocxKnowledge
        from proj.rag.knowledge.html import HTMLKnowledge
        from proj.rag.knowledge.markdown import MarkdownKnowledge
        from proj.rag.knowledge.pdf import PDFKnowledge
        from proj.rag.knowledge.pptx import PPTXKnowledge
        from proj.rag.knowledge.string import StringKnowledge
        from proj.rag.knowledge.txt import TXTKnowledge
        from proj.rag.knowledge.url import URLKnowledge
