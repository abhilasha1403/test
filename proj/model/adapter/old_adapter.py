...
from proj.model.adapter.template import ConversationAdapter, PromptType
from proj.model.base import ModelType
from proj.model.llm.conversation import Conversation
...
if TYPE_CHECKING:
    from proj.app.chat_adapter import BaseChatAdpter
