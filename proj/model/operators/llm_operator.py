...
from proj.core.awel import BaseOperator
from proj.core.operators import BaseLLM, BaseLLMOperator, BaseStreamingLLMOperator
    ...
    def llm_client(self) -> LLMClient:
        if not self._llm_client:
            try:
                ...
                from proj.model.cluster.client import DefaultLLMClient
