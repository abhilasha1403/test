...
from proj.core.interface.message import AIMessage, HumanMessage, StorageConversation
from proj.core.interface.storage import QuerySpec
from proj.storage.chat_history.chat_history_db import (
    ChatHistoryEntity,
    ChatHistoryMessageEntity,
)
from proj.storage.chat_history.storage_adapter import (
    DBMessageStorageItemAdapter,
    DBStorageConversationItemAdapter,
)
from proj.storage.metadata import db
from proj.storage.metadata.db_storage import SQLAlchemyStorage
from proj.util.pagination_utils import PaginationResult
