...
from proj.configs.model_config import EMBEDDING_MODEL_CONFIG
from proj.rag.summary.rdbms_db_summary import RdbmsSummary
...
class DBSummaryClient:
    ...
    def get_db_summary(self, dbname, query, topk):
        ...
        from proj.storage.vector_store.base import VectorStoreConfig
        ...
        from proj.rag.retriever.db_schema import DBSchemaRetriever
    ...
    def init_db_profile(self, db_summary_client, dbname):
        ...
        if not vector_connector.vector_name_exists():
            from proj.serve.rag.assembler.db_schema import DBSchemaAssembler
