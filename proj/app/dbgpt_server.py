...
from proj.app.component_configs import initialize_components
from proj.app.openapi.base import validation_exception_handler
from proj.component import SystemApp
from proj.configs.model_config import (
    EMBEDDING_MODEL_CONFIG,
    LLM_MODEL_CONFIG,
    LOGDIR,
    ROOT_PATH,
)
from proj.util.parameter_utils import _get_dict_from_obj
...
static_file_path = os.path.join(ROOT_PATH, "proj", "app/static")
...
def mount_routers(app: FastAPI):
    ...
    from proj.app.openapi.api_v1.api_v1 import router as api_v1
    
    from proj.app.openapi.api_v1.feedback.api_fb_v1 import router as api_fb_v1
...
def _get_webserver_params(args: List[str] = None):
    from proj.util.parameter_utils import EnvArgumentParser
...
def initialize_app(param: WebServerParameters = None, args: List[str] = None):
    ...
    from proj.model.cluster import initialize_worker_manager_in_client
