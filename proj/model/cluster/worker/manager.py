...
from proj.configs.model_config import LOGDIR
from proj.core import ModelMetadata, ModelOutput
from proj.model.base import ModelInstance, WorkerApplyOutput, WorkerSupportedModel
from proj.model.cluster.base import *
from proj.model.cluster.manager_base import (
    WorkerManager,
...
from proj.model.parameter import ModelWorkerParameters, WorkerType
from proj.model.utils.llm_utils import list_supported_models
from proj.util.parameter_utils import (
    EnvArgumentParser,
    ParameterDescription,
    _dict_to_command_args,
    _get_dict_from_obj,
)
from proj.util.system_utils import get_system_info
from proj.util.tracer import SpanType, SpanTypeRunName, initialize_tracer, root_tracer
from proj.util.utils import setup_http_service_logging, setup_logging
...
def _setup_fastapi(
    ...
    if worker_params.standalone:
        from proj.model.cluster.controller.controller import initialize_controller
...
def _create_local_model_manager(
    ...
    from proj.util.net_utils import _get_ip_address
    ...
    if not worker_params.register or not worker_params.controller_addr:
        ...
        from proj.model.cluster.controller.controller import ModelRegistryClient
...
def _build_worker(worker_params: ModelWorkerParameters):
    ...
    if worker_class:
        ...
        if (
            ...
            from proj.model.cluster.worker.embedding_worker import (
