...
from proj.core import LLMClient, ModelMessageRoleType, ModelRequest
from proj.rag.chunk import Chunk
from proj.rag.extractor.base import Extractor
from proj.util import utils
...
class SummaryExtractor(Extractor):
    ...
    async def _aextract(self, chunks: List[Chunk]) -> str:
        ...
        from proj.util.prompt_util import PromptHelper
    ...
    async def _llm_run_tasks(
        ...
        for chunk_text in chunk_texts:
            from proj.core import ModelMessage
