...
from proj.model.adapter.base import LLMModelAdapter, get_model_adapter
...
from proj.model.parameter import BaseModelParameters
...
def get_llm_model_adapter(
    ...
    if model_type == ModelType.VLLM:
        ...
        from proj.model.adapter.vllm_adapter import VLLMModelAdapterWrapper

        return VLLMModelAdapterWrapper(conv_factory)

    # Import NewHFChatModelAdapter for it can be registered
    from proj.model.adapter.hf_adapter import NewHFChatModelAdapter
    from proj.model.adapter.proxy_adapter import ProxyLLMModelAdapter
    ...
    if use_fastchat and not must_use_old:
        ...
        from proj.model.adapter.fschat_adapter import (
        ...
        from proj.app.chat_adapter import get_llm_chat_adapter
        from proj.model.adapter.old_adapter import OldLLMModelAdapterWrapper
        from proj.model.adapter.old_adapter import (
