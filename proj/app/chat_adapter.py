...
from proj.model.llm.conversation import Conversation, get_conv_template
...
class BaseChatAdpter:
    ...
    def get_generate_stream_func(self, model_path: str):
        ...
        from proj.model.llm.inference import generate_stream
...
class VicunaChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.vicuna_base_llm import generate_stream
...
class ChatGLMChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.chatglm_llm import chatglm_generate_stream
...
class GuanacoChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.guanaco_llm import guanaco_generate_stream
...
class FalconChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.falcon_llm import falcon_generate_output
...
class GorillaChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.gorilla_llm import generate_stream
...
class GPT4AllChatAdapter(BaseChatAdpter):
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.gpt4all_llm import gpt4all_generate_stream
...
class LlamaCppChatAdapter(BaseChatAdpter):
    def match(self, model_path: str):
        from proj.model.adapter.old_adapter import LlamaCppAdapater
    ...
    def get_generate_stream_func(self, model_path: str):
        from proj.model.llm_out.llama_cpp_llm import generate_stream
