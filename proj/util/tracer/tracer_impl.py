...
from proj.util.tracer.span_storage import MemorySpanStorage
...
def initialize_tracer(
    ...
    if not system_app:
        return
    from proj.util.tracer.span_storage import FileSpanStorage, SpanStorageContainer
    ...
    if system_app.app:
        from proj.util.tracer.tracer_middleware import TraceIDMiddleware
