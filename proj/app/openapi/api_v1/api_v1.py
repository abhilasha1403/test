...
from proj.app.openapi.api_view_model import (
...
from proj.app.scene import BaseChat, ChatFactory, ChatScene
from proj.component import ComponentType
from proj.configs.model_config import KNOWLEDGE_UPLOAD_ROOT_PATH
from proj.datasource.db_conn_info import DBConfig, DbTypeInfo
from proj.model.base import FlatSupportedModel
from proj.model.cluster import BaseModelController, WorkerManager, WorkerManagerFactory
from proj.rag.summary.db_summary_client import DBSummaryClient
from proj.util.executor_utils import (
    DefaultExecutorFactory,
    ExecutorFactory,
    blocking_func_to_async,
)
from proj.util.tracer import SpanType, root_tracer
...
def get_hist_messages(conv_uid: str):
    from proj.serve.conversation.serve import Service as ConversationService
